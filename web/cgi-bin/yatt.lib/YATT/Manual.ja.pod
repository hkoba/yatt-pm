...
インストールには直接 Subversion を使ってください。
  ...
  svn co https://yatt-pm.svn.sourceforge.net/svnroot/yatt-pm/trunk/yatt-pm/web/cgi-bin
  # もしくは、開発サイト:
  # svn co https://buribullet.net/svn/yatt-pm/web/cgi-bin
...
=head3 (a) C<< <!yatt:widget NAME ARG1 ARG2=TYPE?DEFAULT ...> >>
...
呼び出すときには C<< &yatt:body(); >> と書きます。
  ...
  *: default の話
  *: 型の話
  *: <:yatt:ARG1/> の話、 <:yatt:ARG1>...</:yatt:ARG1> も。

=head3 (b) C<< <!yatt:args ARG1 ARG2=TYPE?DEFAULT ...> >>
